...
router.post('/', verifyAdminOrStaff,upload.array('files',1), categoryController.createCategory);  // Tạo mới danh mục (Chỉ admin có quyền)
...
router.put('/:id', verifyAdminOrStaff, categoryController.updateCategory);  // Cập nhật danh mục theo ID (Chỉ admin có quyền)

/* DELETE category by ID. */
router.delete('/:id', verifyAdminOrStaff, categoryController.deleteCategory);  // Xóa danh mục theo ID (Chỉ admin có quyền)
